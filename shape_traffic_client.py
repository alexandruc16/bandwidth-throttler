...
set_group.add_argument("--set-all",
					   help="throttle the bandwidth of an interface on the given machines: <ip>:<bandwidth>")
set_group.add_argument("--reset", help="removes the bandwidth throttles on the given machines: <ip1>:<ip2>:..")
set_group.add_argument("--set-file",
					   help="the given file specifies the bandwidth between machines. See --set for the correct syntax")
set_group.add_argument("--set-all-file",
					   help="the given file specifies the bandwidth of the interface on machines. See --set-all for the correct syntax")
